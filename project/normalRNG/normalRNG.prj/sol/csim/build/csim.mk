...
$(ObjDir)/tb.o: ../../../../tb.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -ID:/tmp/Vitis_Libraries/quantitative_finance//L1/include -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb.d

$(ObjDir)/dut.o: ../../../../dut.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../dut.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -ID:/tmp/Vitis_Libraries/quantitative_finance//L1/include  $(IFLAG) $(DFLAG) $< -o $@ ; \
